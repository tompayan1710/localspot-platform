...
import ListScanStatistic from "./ListScanStatistic"

export default function TabScanContainer({scans, scansloading, scanserror}) {
  ...
  return (
    <div className="ContainerListeEmplacementActif">
      ...
      <ListScanStatistic scans={scans}></ListScanStatistic>
    </div>
  );
}
